...
$paragraph->id_story = isset($data->id_story) ? $data->id_story : exit(json_encode(array( "message" => "Access denied.", "error" => "NO PARAGRAPH SENT")));
